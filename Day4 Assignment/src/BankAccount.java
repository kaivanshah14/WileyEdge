...
public class BankAccount {
	...
	public BankAccount(int accountId, String accountHolderName, double currentBalance) {
		super();
		openingBalance = 5000;
	...
	private boolean checkforCurrentBalance(double currentBalance2) {
		if(currentBalance2<0) {
			System.out.println("Invalid operation: Current Balance cannot be less than 0, current balance will be calculated as 0");
			return false;
		}
		return true;
	}
	...
	public void depositAmount(double amount) {
		if(amount<0) System.out.println("ERROR: Cannot deposit amount, deposit amount cannot be less than 0");
		else{
			currentBalance += amount;
			totalBalance += amount;
			System.out.println("Amount deposited: " + amount + " Current Balance: " + currentBalance + " | Old balance was: " + (currentBalance-amount));
		}
	}

	public void withdrawAmount(double amount) {
		if (amount > currentBalance)
			System.out.println("ERROR: Cannot withdraw amount, insufficient balance, available balance: " + currentBalance);
		else {
			double temp = currentBalance;
			currentBalance -= amount;
			totalBalance -= amount;
			System.out.println("Amount withdrawn: " + amount + " Current Balance: " + currentBalance + " | Old balance was: " + (temp));
		}
	...
	public void getAccountInfo() {
		System.out.println("Account ID: " + accountId + " | Account Name: " + accountHolderName + " | Current Balance: " + currentBalance);
	}
