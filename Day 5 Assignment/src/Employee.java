...
public class Employee{
	...
	public void displayEmployee() {
		System.out.println("Employee ID: " + empId + " | Employee Name: " + empName + " | Employee Department: " + empDept +  " | Employee Salary: " + empGrossSalary);
	}
}
...
class SortEmployee implements Comparator<Employee>{
	...
	public int compare(Employee o1, Employee o2) {
		if(o1.getGrossSalary()<o2.getGrossSalary()) return -1;
		else return 1;
	}
